...
<head>
  ...
  <link href="../../css/bootstrap5.0.1.min.css" rel="stylesheet">
    ...
    <title>Resepsionis - <?php echo $judul ?></title>
       ...
       <div class="row mb-2">
         ...
         <div class="col-sm-6">
           <ol class="breadcrumb float-sm-right">
             <li class="breadcrumb-item">HotelDK</li>
           </ol>
         </div>
       </div>
     </div>
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">Data Table Fasilitas Kamar</h3>
          </div>
          <div class="card-body">
            <div class="d-flex justify-content-between d-flex flex-row-reverse">
             <div class="form-floating mb-2 mt-3 ">
              ...
              <div class="form-floating mb-2 mt-3">
                <button type="button" onclick="add_modal_fasilitas()" class="btn btn-block btn-outline-dark">Tambah Data</button>
             </div>
            </div>
...
function load_fasilitas_umum() 
{
 ...
 $.ajax({
  ...
  {
    $.ajax({
     url: "delete_fasilitas_kamar.php",
     method: "POST",
     data:{
            idp:id
          },
...
$(function(){ 
   ...
   else
   {
     ...
     $.ajax({
     url: "tambah_fasilitas_kamar.php",
     method: "POST",
     data: form_data,
     contentType: false,
     cache: false,
