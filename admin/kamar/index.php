    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Data Table Kamar</h3>
        </div>
        <div class="card-body">
          <div class="d-flex justify-content-between d-flex flex-row-reverse">
              <div class="form-floating mb-2 mt-3">
               ...
               <div class="form-floating mb-2 mt-3">
                  <button type="button" onclick="add_modal_kamar()" class="btn btn-block btn-dark">Tambah Data</button>
               </div>
          </div>  
           ...
           <table id="tb_kamar" class="table table-striped" style="width:100%">
            <thead>
              <tr>
                  ...
                  <th class="text-center">Harga Kamar</th>
            ...
            <tbody>
              ...
              <tr>
                  ...
                  <td class="text-center"><?php echo "Rp. " . (number_format($row["harga"])) . " per hari"; ?></td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="form_k">
          ...
          <div class="mb-3 mt-3 form-floating">
            <input type="number" class="form-control" id="harga_kamar" name="harga_kamar">
...
$(function(){ 
    $("#add_kamar").on('click', function(){
     ...
     var hkamar  = $("#harga_kamar").val();

   if ( (nama=="") || (jkamar=="") || (hkamar=="") )
   {
...
$(function(){ 
    $("#update_kamar").on('click', function(){
     ...
     var eharga  = $("#eharga_kamar").val();

   if ( (enama=="") || (ejkamar=="") || (eharga==""))
   {
        alert("Terjadi kesalahan. Ada data yang kosong!");
        return;
   }
